...
from FriendsFinder.models import Category
from FriendsFinder.models import Page
from FriendsFinder.forms import CategoryForm
from FriendsFinder.forms import PageForm
...
# Go render the response and return it to the client.
	return render(request, 'FriendsFinder/category.html', context_dict)
...
# just print them to the terminal.
		print(form.errors)
	return render(request, 'FriendsFinder/add_category.html', {'form': form})
...
def add_page(request, category_name_slug):
	...
	return render(request, 'FriendsFinder/add_page.html', context_dict)

@login_required
def add_post(request, thread_title_slug):
	try:
		thread = Thread.objects.get(slug=thread_title_slug)
	except Category.DoesNotExist:
		thread = None
